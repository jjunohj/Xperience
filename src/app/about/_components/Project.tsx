  ...
  return (
    <div className="flex w-full flex-col gap-1.5">
      <div className="flex w-full flex-col-reverse items-start justify-between sm:flex-row">
        <h1 className="text-base font-semibold dark:text-white sm:text-lg lg:text-xl">{props.title}</h1>
        <span className="w-fit text-base font-light dark:text-white sm:text-lg sm:font-normal lg:text-xl">
          {props.period}
        </span>
      </div>
      <span className="text-sm text-black dark:text-white sm:text-base">{props.description}</span>
