...
export const career: Career[] = [
  {
    ...
    company: "STEALIEN",
    team: "솔루션사업본부 개발실 / Web팀",
    role: "책임 연구원 (Lead Researcher)",
    period: "2024.08 ~ 재직 중",
    stacks: [
      "Next.js",
      "React",
    ...
    info: [
      "WASM 기반 웹 보안 키패드 클라이언트 구현: JS-C++ 간 타입 차이를 직렬화/추상화하고 TypeScript Wrapper로 안정적인 인터페이스 설계",
      "전사 암복호화 표준 모듈 도입 및 성능 개선: RSA 공개키/개인키 생성 시간 약 40% 단축 (2.0초 → 1.2초)",
      "사내 모노레포 전환 주도: 파편화된 서비스의 의존성/개발환경 표준화 및 공통 설정 패키지(ts/lint/prettier/tailwind) 구축",
      "디자인 시스템 기반 공통 UI 정비로 중복 코드 제거 및 신규 기능 개발 속도 향상",
      "Docker + Harbor + SSH + GitLab Runner 기반 독립 배포 파이프라인 구축(main 머지 시 TEST 자동 배포)",
      "모바일 앱 보안 솔루션 관리 페이지 성능 개선: 초기 로딩 20초+에서 2초 미만으로 단축(약 90%), INP/LCP 개선",
    ],
  },
];
...
export const projects: Project[] = [
  {
    title: "Nudge - 샵인샵 팝업 중개 플랫폼",
    description: "카페와 브랜드의 오프라인 협업을 연결하는 온라인 채널 및 커머스",
    role: "Frontend Engineer | 아주대학교 창업동아리 Nudge 팀",
    period: "창업동아리 프로젝트",
    stacks: [
      "Next 15",
      "React 19",
    ...
    info: [
      "HttpOnly 쿠키 기반 Access/Refresh 토큰 전략과 Proxy API Route를 적용해 클라이언트 인증 정보 노출을 최소화",
      "인풋 세니타이징/이스케이핑으로 XSS 대응 및 Next 환경에 최적화된 커스텀 API Client 구축",
      "MobileLayout 중심 템플릿 시스템으로 TopNav/CTAButton/BottomSheet/MenuDrawer 등 모바일 UI를 모듈화",
      "ReactQuery prefetchQuery + HydrationBoundary 기반 서버사이드 프리패칭으로 초기 로딩 성능 개선",
      "middleware + userAgent 기반 SSR/CSR 통합 디바이스 감지 체계 구축(x-viewport 헤더/viewport 쿠키 이중화)",
      "2024 기술보증기금 1억 원 승인",
    ],
  },
  {
