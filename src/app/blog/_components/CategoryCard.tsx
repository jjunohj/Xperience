    ...
    >
      <button
        ...
        className={cn(
          ...
          "border border-neutral-200/20 focus:ring-brand-700/30 dark:border-neutral-700/30",
          "h-28 w-40 sm:h-32 sm:w-48 md:h-36 md:w-56",
          "group cursor-pointer select-none backdrop-blur-sm",
          isSelected ? "shadow-lg ring-2 ring-brand-700/40 ring-offset-2" : "shadow-md",
        )}
      >
        {/* 배경 이미지와 오버레이 */}
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-brand-700/10" />
        </div>
        ...
        <div className="absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <div className="absolute inset-0 bg-gradient-to-br from-brand-700/5 to-brand-700/10" />
        </div>
      </button>
    </motion.div>
  );
